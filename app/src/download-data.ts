...
export const PLATFORMS: (Omit<PlatformDownloads, "files"> & {
...
})[] = [
  {
    id: "windows",
    files: [
      { name: `GenePad_${VERSION}_Windows_amd64.zip`, size: "8.3 MB" },
    ].map(withSources),
  },
  {
    id: "mac",
    files: [
      { name: "macos-dmg.zip", size: "10.4 MB" },
      { name: "macos-app.zip", size: "9.9 MB" },
    ].map(withSources),
  },
  {
    id: "linux-x64",
    files: [
      ...
      { name: `GenePad_${VERSION}_Linux_amd64.rpm`, size: "11.1 MB" },
      { name: `GenePad_${VERSION}_Linux_amd64.tar.gz`, size: "10.1 MB" },
    ].map(withSources),
    sparkStore: true,
  },
  {
    id: "linux-arm64",
    files: [
      { name: `GenePad_${VERSION}_Linux_arm64.deb`, size: "10.8 MB" },
      { name: `GenePad_${VERSION}_Linux_arm64.rpm`, size: "10.8 MB" },
      { name: `GenePad_${VERSION}_Linux_arm64.tar.gz`, size: "9.8 MB" },
    ].map(withSources),
    sparkStore: true,
  },
  {
    id: "android",
    files: [{ name: "app-universal-release.apk", size: "22.4 MB" }].map(withSources),
  },
];
