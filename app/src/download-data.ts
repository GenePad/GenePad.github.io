...
export const PLATFORMS: (Omit<PlatformDownloads, "files"> & {
  ...
  },
  {
    id: "mac",
    files: [
      { name: `GenePad_${VERSION}_Darwin_arm64.dmg`, size: "10.6 MB" },
    ].map(withSources),
  },
  {
    id: "linux-x64",
    files: [
      { name: `GenePad_${VERSION}_Linux_amd64.deb`, size: "10.7 MB" },
    ].map(withSources),
    sparkStore: true,
  },
  {
    id: "android",
    files: [
      { name: `GenePad-v${VERSION}-android-universal-release.apk`, size: "24.5 MB" },
    ].map(withSources),
  },
];
